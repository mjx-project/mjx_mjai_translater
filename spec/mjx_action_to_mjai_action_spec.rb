...
RSpec.describe  MjxToMjai do
  ...
  it "手出し" do
    ...
    expected_mjai_action = Mjai::Action.new({:type=>:dahai, :actor=>0, :pai=>Mjai::Pai.new("1m"), :tsumogiri=>false})  # 今は起家から順番に恣意的に0,1,2,3とidを決めている。trans_server のインスタンス変数がその対応を全て管理しているので別の問題
