...
RSpec.describe  TransServer do
    ...
    it "局の最初" do
        ...
        difference_extracted = TransServer.new({:target_id=>1}).extract_difference(observation)  # 差分を取得する関数を動かす  
    ...
    it "局の途中" do
        ...
        difference_extracted = TransServer.new({:target_id=>1}).extract_difference(observation_previous.public_observation.events, observation)
